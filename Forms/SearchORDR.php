...
$b=0;
$btotal=0;
$bsql=mysql_query("SELECT registrationNo, cashPaid, datePaid, timePaid, paidBy, description, paidVia, orNO FROM patientCharges WHERE orNO NOT LIKE '%cm%' AND (datePaid BETWEEN '$fdate' AND '$tdate') ORDER BY datePaid");
