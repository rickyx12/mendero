...
mysql_query("UPDATE patientRecordAddInfo SET birthPlace='$birthPlace',  nationality='$nationality', pxOccupation='$pxOccupation', fathersName='$fathersName', fatherAddress='$fatherAddress', fatherContactNo='$fatherContactNo', mothersName='$mothersName', motherAddress='$motherAddress', motherContactNo='$motherContactNo', spouseName='$spouseName', spouseAddress='$spouseAddress', spouseContactNo='$spouseContactNo', dateAdded='$dateAdded', addedBy='$username'");
...
";
echo "<META HTTP-EQUIV='Refresh'CONTENT='2;URL=AdmissionFillUpMoreDetails.php?username=$username&registrationNo=$registrationNo'>";
?>
</body>
</html>
