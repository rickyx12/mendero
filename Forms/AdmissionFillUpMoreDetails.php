    ...
    <tr>
      <td class='table1Top1Bottom1Left1Right'><table width='100%' border='0' cellspacing='0' cellpadding='0'>
        ...
        <tr>
          ...
          <td width='34%' height='30' class='table1Left'><div align='center' class='style2'><input type='text' name='fatherAddress' class='textfield1' value='$fatherAddress' /></div></div></td>
    ...
    <tr>
      <td class='table1Top1Bottom1Left1Right'><table width='100%' border='0' cellspacing='0' cellpadding='0'>
        ...
        <tr>
          ...
          <td width='34%' height='30' class='table1Left'><div align='center' class='style2'><input type='text' name='motherAddress' class='textfield1' value='$motherAddress' /></div></div></td>
    ...
    <tr>
      <td class='table1Top1Bottom1Left1Right'><table width='100%' border='0' cellspacing='0' cellpadding='0'>
        ...
        <tr>
          ...
          <td width='34%' height='30' class='table1Left'><div align='center' class='style2'><input type='text' name='spouseAddress' class='textfield1' value='$spouseAddress' /></div></div></td>
