          ...
          <td><table border='0' width='100%' cellspacing='0' cellpadding='0'>
            <tr>
              ...
              <td width='30%' valign='top' height='20' class='table1Bottom1Left'><table border='0' width='100%' cellspacing='0' cellpadding='0'>
                <tr>
                  <td height='20'><div align='left' class='style3'><a href='AdmissionFillUpMoreDetailsPlus.php?username=$username&registrationNo=$registrationNo' class='style3' target='_blank'>&nbsp;Social Service Classification:</a></div></td>
                </tr>
                <tr>
        ...
        <tr>
          <td><table border='0' width='100%' cellspacing='0' cellpadding='0'>
            <tr>
              <td width='50%' height='20' class='table1Bottom1Left'><table border='0' width='100%' cellspacing='0' cellpadding='0'>
                <tr>
                  <td width='115'><div align='left' class='style3'><a href='AdmissionFillUpMoreDetailsPlus.php?username=$username&registrationNo=$registrationNo' class='style3' target='_blank'>&nbsp;Informant's Name:</a></div></td>
                  <td><div align='left' class='style5'>&nbsp;</div></td>
                </tr>
              </table></td>
              <td width='50%' class='table1Bottom1Left1Right'><table border='0' width='100%' cellspacing='0' cellpadding='0'>
                <tr>
                  <td width='130'><div align='left' class='style3'><a href='AdmissionFillUpMoreDetailsPlus.php?username=$username&registrationNo=$registrationNo' class='style3' target='_blank'>&nbsp;Address of Informant:</a></div></td>
                  <td><div align='left' class='style5'>&nbsp;</div></td>
                </tr>
              </table></td>
            </tr>
        ...
        <tr>
          <td><table border='0' width='100%' cellspacing='0' cellpadding='0'>
            <tr>
              <td width='50%' height='20' class='table1Bottom1Left'><table border='0' width='100%' cellspacing='0' cellpadding='0'>
                <tr>
                  <td><div align='left' class='style3'><a href='AdmissionFillUpMoreDetailsPlus.php?username=$username&registrationNo=$registrationNo' class='style3' target='_blank'>&nbsp;Relation to Patient:</a></div></td>
                  <td><div align='left' class='style5'>&nbsp;</div></td>
                </tr>
              </table></td>
              <td width='50%' class='table1Bottom1Left1Right'><table border='0' width='100%' cellspacing='0' cellpadding='0'>
                <tr>
                  <td><div align='left' class='style3'><a href='AdmissionFillUpMoreDetailsPlus.php?username=$username&registrationNo=$registrationNo' class='style3' target='_blank'>&nbsp;Contact No.:</a></div></td>
                  <td><div align='left' class='style5'>&nbsp;</div></td>
                </tr>
              </table></td>
            </tr>
          ...
          <td><table border='0' width='100%' cellspacing='0' cellpadding='0'>
            <tr>
              <td width='40%' valign='top' height='20' class='table1Bottom1Left'><table border='0' width='100%' cellspacing='0' cellpadding='0'>
                <tr>
                  <td><div align='left' class='style3'><a href='AdmissionFillUpMoreDetailsPlus.php?username=$username&registrationNo=$registrationNo' class='style3' target='_blank'>&nbsp;Discharge Condition:</a></div></td>
                </tr>
                <tr>
              ...
              <td width='25%' valign='top' height='20' class='table1Bottom1Left'><table border='0' width='100%' cellspacing='0' cellpadding='0'>
                <tr>
                  <td height='20'><div align='left' class='style3'><a href='AdmissionFillUpMoreDetailsPlus.php?username=$username&registrationNo=$registrationNo' class='style3' target='_blank'>&nbsp;Disposition:</a></div></td>
                </tr>
                <tr>
