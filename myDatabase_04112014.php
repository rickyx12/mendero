...
public function addNewRegistration($patientNo,$registrationNo,$bloodPressure,$temperature,$height,$weight,$company,$initialDiagnosis,$dateRegistered,$timeRegistered,$branch,$type,$room,$username,$casetype,$limit,$control_dateRegistered,$diet,$pulse,$respiratory) {
...
$sql="INSERT INTO registrationDetails (patientNo,registrationNo,bloodPressure,temperature,height,weight,Company,initialDiagnosis,dateRegistered,timeRegistered,branch,type,room,PIN,registeredBy,casetype,LimitCASH,control_dateRegistered,diet,pulseRate,respiratoryRate)
VALUES
...
}else if( $this->getPatientRecord_phic() == "YES" && $this->getRegistrationDetails_type() == "IPD" ) {
...
if( $this->getRegistrationDetails_company() != "" && $this->getRegistrationDetails_type() != "OPD" ) {
echo "<td>&nbsp;".number_format($priceOption[1] + ($priceOption[1] * 0.35) ,2)."&nbsp;</td>"; 
