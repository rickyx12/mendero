...
if( $room == "OPD" ) { /*dont prompt*/ }
else if( $room == "OB-Package" ) { /*dont prompt*/  }
else {
echo "<script type='text/javascript'>";
echo "alert('Pls Select Private Case or House Case before to proceed');";
echo "history.back();";
echo "</script>";
}
...
echo "<input type=hidden name='infectionControl' value='$infectionControl' >";
echo "<input type=hidden name='service' value='$newservice' >";
echo "</form>";
