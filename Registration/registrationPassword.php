...
$infectionControl = $_POST['infectionControl'];
...
if($ro->getUserRegistrar() == "REGISTRATION" || $ro->getUserRegistrar() == "PHARMACY" || $ro->getUserRegistrar() == "CASHIER" || $ro->getUserRegistrar() == "LABORATORY" || $ro->getUserRegistrar() == "ER" || $ro->getUserRegistrar() == "RADIOLOGY" || $ro->getUserRegistrar() == "ADMITTING") { //IF 1
...
if($room == "OPD") {
$ro->addNewRegistration($patientNo,$registrationNo,$bloodpressure,$patientTemperature,$height,$weight,$company,$diagnosis,$dateRegistered,$serverTime,$ro->getUserBranch($password),"OPD","OPD_OPD",$ro->getUserRegistered(),$casetype,"2000",date("Y-m-d"),$diet,$pulse,$respiratory,$from,$infectionControl,$service);
}else if($room == "OB-Package") {
$ro->addNewRegistration($patientNo,$registrationNo,$bloodpressure,$patientTemperature,$height,$weight,$company,$diagnosis,$dateRegistered,$serverTime,$ro->getUserBranch($password),"OB-Package","OB-Package_OB-Package",$ro->getUserRegistered(),$casetype,"2000",date("Y-m-d"),$diet,$pulse,$respiratory,$from,$infectionControl,$service);
}else if($room == "OR/DR") {
$ro->addNewRegistration($patientNo,$registrationNo,$bloodpressure,$patientTemperature,$height,$weight,$company,$diagnosis,$dateRegistered,$serverTime,$ro->getUserBranch($password),"OR/DR","OR/DR_OR/DR",$ro->getUserRegistered(),$casetype,"2000",date("Y-m-d"),$diet,$pulse,$respiratory,$from,$infectionControl,$service);
}else {
$ro->addNewRegistration($patientNo,$registrationNo,$bloodpressure,$patientTemperature,$height,$weight,$company,$diagnosis,$dateRegistered,$serverTime,$ro->getUserBranch($password),"IPD",$room,$ro->getUserRegistered(),$casetype,"2000",date("Y-m-d"),$diet,$pulse,$respiratory,$from,$infectionControl,$service);
