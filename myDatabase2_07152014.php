...
$result = mysqli_query($connection, " select pc.description,total from patientRecord pr,registrationDetails rd,patientCharges pc where pc.registrationNo = '$registrationNo' and pc.registrationNo = rd.registrationNo and rd.patientNo = pr.patientNo and pc.datePaid = '$date' and rd.type='$type' and pc.title='LABORATORY' and pc.status = 'PAID' ") or die("Query fail: " . mysqli_error()); 
...
$result = mysqli_query($connection, " select count(datePaid) as totalReg from patientCharges where registrationNo = '$registrationNo' and title = 'LABORATORY' and status = 'PAID' group by datePaid  ") or die("Query fail: " . mysqli_error()); 
...
$result = mysqli_query($connection, " select  min(datePaid) as datePaid from patientCharges where registrationNo = '$registrationNo' and title = 'LABORATORY' and status = 'PAID' group by datePaid limit 1  ") or die("Query fail: " . mysqli_error()); 
...
echo "<td width='40%'>". $this->getPxChargesByHorizontal($row['dateCharge'],$type,$registrationNo)."</td>";
