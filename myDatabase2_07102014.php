...
$this->coconutTableData( $this->getPxChargesByHorizontal($row['dateCharge'],$type,$registrationNo)."<br><font size=2 color=blue>Total:".number_format(($this->getPxChargesByHorizontal_total),2)."</font><br><font size=2 color=blue>Rebate:".( $this->getPxChargesByHorizontal_total * 0.05 )."</font>" );
$this->coconutTableRowStop();
}
