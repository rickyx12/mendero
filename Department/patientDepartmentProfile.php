...
echo "<br><br><a href='http://".$ro->getMyUrl()."/COCONUT/Laboratory/labFormPrint2.php?registrationNo=$registrationNo&dateCharge=$dateCharge' target='_blank'><font color=red size=2><< Print Lab Request >></font></a>";
