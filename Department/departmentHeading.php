...
if($module != "BILLING" && $module != "PHARMACY" && $module != "LABORATORY" && $module != "DIETARY" && $module != "CSR" && $module != "ER" && $module !="ADMITTING") {
...
echo '<li><a href="http://'.$ro->getMyUrl().'/COCONUT/Pharmacy/searchReg.php" target="departmentX">Search Registration No#</a></li>';
...
echo ' <li><a href="http://'.$ro->getMyUrl().'/COCONUT/maintenance/searchInventory.php?username='.$username.'&inventoryType=&branch=All&show=search&inventoryLocation=PHARMACY" target="departmentX" >Search Inventory</a></li>';
...
echo  ' <li><a href="http://'.$ro->getMyUrl().'/COCONUT/convenience/homepage.php?username='.$username.'" target="departmentX">Convenience</a></li>';

echo  ' <li><a href="http://'.$ro->getMyUrl().'/COCONUT/Pharmacy/searchOR.php" target="departmentX">Search OR#</a></li>';
...
echo ' <li><a href="http://'.$ro->getMyUrl().'/COCONUT/maintenance/searchInventory.php?username='.$username.'&inventoryType=&branch=All&show=search&inventoryLocation=CSR" target="departmentX" >Search Inventory</a></li>';
...
echo ' <li><a href="http://'.$ro->getMyUrl().'/COCONUT/masterfile/inventory.php?username='.$username.'&inventoryType=&inventoryLocation=CSR&branch=All&show=All" target="departmentX" >Inventory </a></li>';


}else if( $module == "ER" || $module == "ADMITTING" ) {
...
if($module=="ER"){
echo  ' <li><a href="http://'.$ro->getMyUrl().'/COCONUT/Reports/Census/roomSegregated1.php" target="_blank">Census By Room</a></li>';
}
...
<li><a href="../Forms/LabDoctorCompensReportSD.php?username=<?php echo $username; ?>" target="departmentX">Doctor Compensation</a></li>

<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/Laboratory/labCensus/dateLab.php" target="departmentX">Lab Charges</a></li>

<li><a href="../Forms/DailyLabCensusSD.php?username=<?php echo $username; ?>" target="departmentX">Daily Laboratory Census</a></li>

<li><a href="../Forms/DeletedLabTestsSD.php?username=<?php echo $username; ?>" target="departmentX">Daily Deleted Test/s</a></li>

<li><a href="../Forms/DeletedLabRequestSD.php?username=<?php echo $username; ?>" target="departmentX">Daily Deleted Lab Request/s</a></li>
...
<?php } ?>
                    ...
                    <li><a href="../Forms/CensusMasterListSD.php?module=<?php echo $module; ?>&username=<?php echo $username; ?>" target="departmentX" >Patient Census Master List</a></li>
...
echo '<li><a href="http://'.$ro->getMyUrl().'/COCONUT/inventory/inventoryDepartmentReturnList.php?username='.$username.'&returnTo='.$module.'" target="departmentX">Return From Inventory</a></li>';

echo '<li><a href="http://'.$ro->getMyUrl().'/COCONUT/inventory/inventoryDepartmentReturnDate.php?username='.$username.'&returnTo='.$module.'" target="departmentX">Return From Inventory Report</a></li>';
...
<li>
<a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/convenience/transactionHome.php?username=<?php echo $username; ?>" target="departmentX">Convenience Transact</span></a>
</li>
<?php } else { } ?>  
...
echo "
<iframe src='../COCONUT/availableCharges/searchChargesModule.php?module=$module&username=$username' style='border:0px;width:100%;height:100%;' name='departmentX' border=1 frameborder=no></iframe>
";
}
else if($module=='PHARMACY'){
echo "
<iframe src='../Forms/PharmacyExpiryMeds.php?module=$module&username=$username' style='border:0px;width:100%;height:100%;' name='departmentX' border=1 frameborder=no></iframe>
";
}
else{
echo "
<iframe src='../Department/departmentPage.php?' style='border:0px; width:100%; height:100%;' name='departmentX' border=1 frameborder=no></iframe>
";
}
?>
</body>
