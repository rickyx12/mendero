...
echo "<br><center><div style='border:1px solid #000000; width:500px; height:370px; border-color:black black black black;'>";
...
echo "<Td>Charging</td>";
echo "<td>";
$ro->coconutComboBoxStart_long("chargingStatus");
echo "<option value='".$ro->selectNow("inventory","chargeControl","inventoryCode",$inventoryCode)."'>".$ro->selectNow("inventory","chargeControl","inventoryCode",$inventoryCode)."</option>";
