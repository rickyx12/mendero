...
if( $title == "LABORATORY" && $ro->selectNow("availableCharges","discount","chargesCode",$chargesCode) == "yes" ) {
if(( $ro->selectNow("registrationDetails","type","registrationNo",$registrationNo) == "OPD" )||( $ro->selectNow("registrationDetails","type","registrationNo",$registrationNo) == "IPD" )){ //check kung opd if yes 10% [Jan 31,2015]
