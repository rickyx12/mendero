...
//if Reason is blank
if($remarks==""){
echo "<br><br><div align='center'><font size='4' color='red'><b>Please input your reason.</b></font></div>";
echo "<META HTTP-EQUIV='Refresh'CONTENT='2;URL=http://".$ro->getMyUrl()."/COCONUT/patientProfile/patientChargesTitle.php?registrationNo=$registrationNo&title=$titlez&username=$username&show=$show&desc=$desc'>";
}
else{
...
echo "<br><br><div align='center'><font size='4' color='red'><b>Notify supervisor to delete the charge completely.</b></font></div>";
