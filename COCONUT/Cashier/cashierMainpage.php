...
<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/Pharmacy/searchReg.php" target="departmentX">Search Registration No#</a></li>
...
<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/Reports/IPDBalancePerRoomSelectDate.php" target="departmentX">Admission Balance</a></li>
...
<li><a href="http://<?php echo $ro->getMyUrl(); ?>/Forms/SearchORDRSD.php?username=<?php echo $username; ?>" target="_blank">O. R. Summary</a></li>
