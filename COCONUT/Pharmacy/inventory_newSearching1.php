...
xmlhttp.open("GET","inventory_newSearching.php?description="+document.addCharge.description.value+"&username="+document.addCharge.username.value,true);
xmlhttp.send();
}
...
echo "</form>";
echo "<center><div id='livesearch'></div>";
echo "</body>";
?>
