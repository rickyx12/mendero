...
echo "<center>";
echo "<a href='http://".$ro->getMyUrl()."/COCONUT/android/doctor/planPreview_handler.php?registrationNo=$registrationNo' style='color:black;'><font size=4><b>MENDERO MEDICAL CENTER</b></font></a>";
echo "<Br>";
echo "<font size=3>Consolacion,Cebu</font>";
//echo "<br>";
