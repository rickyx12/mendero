...
<input type=text class='panz' maxlength=1 value='H'><input type=text class='panz1' maxlength=1 value='0'><input type=text class='panz1' maxlength=1 value='7'><input type=text class='panz1' maxlength=1 value='0'><input type=text class='panz1' maxlength=1 value='2'><input type=text class='panz1' maxlength=1 value='3'><input type=text class='panz1' maxlength=1 value='9'><input type=text class='panz1' maxlength=1 value='2'><input type=text class='panz1' maxlength=1 value='7'>
</td>
</tr>
