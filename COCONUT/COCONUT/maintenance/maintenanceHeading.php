...
<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=3A E CART&branch=All&show=All" target='departmentX'>3A E CART</a></li>
                   ...
                   <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=ENDOSCOPY E CART&branch=All&show=All" target='departmentX'>ENDOSCOPY E CART</a></li>

                   <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=HEMODIALYSIS E CART&branch=All&show=All" target='departmentX'>HEMODIALYSIS E CART</a></li>

                   <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=CARDIOLOGY E CART&branch=All&show=All" target='departmentX'>CARDIOLOGY E CART</a></li>

                   <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=RADIOLOGY E CART&branch=All&show=All" target='departmentX'>RADIOLOGY E CART</a></li>
...
<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=OR PACKAGE&branch=All&show=All" target='departmentX'>OR PACKAGE</a></li>
<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=(MINOR OR) ER PACKAGE&branch=All&show=All" target='departmentX'>(MINOR OR) ER PACKAGE</a></li>
...
<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/maintenance/searchInventory.php?username=<?php echo $username; ?>&inventoryType=OR PACKAGE&branch=All&show=search" target='departmentX'>OR PACKAGE</a></li>
<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/maintenance/searchInventory.php?username=<?php echo $username; ?>&inventoryType=(MINOR OR) ER PACKAGE&branch=All&show=search" target='departmentX'>(MINOR OR) ER PACKAGE</a></li>                    
