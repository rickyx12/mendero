...
if( $ro->getRegistrationDetails_company() != "" ) { //kpg hmo walang limit
...
echo "<li>".$ro->coconutImages_return("locked1.jpeg")."<a href='http://".$ro->getMyUrl()."/COCONUT/patientProfile/ECART/cartHandler.php?registrationNo=".$ro->getRegistrationDetails_registrationNo()."&username=$username&room=".$ro->getRegistrationDetails_room()."&batchNo=$batchNo' target='rightFrame'><font size=2 color=red>Charges Cart</font></a></li>";
}else {
...
echo "<li><a href='http://".$ro->getMyUrl()."/COCONUT/patientProfile/ECART/cartHandler.php?registrationNo=".$ro->getRegistrationDetails_registrationNo()."&username=$username&room=".$ro->getRegistrationDetails_room()."&batchNo=$batchNo' target='rightFrame'>".$ro->coconutImages_return("locked1.jpeg")."<font size=2 color=red>Charges Cart</font></a></li>";
}else {
