...
echo "<center><img src='http://".$ro->getMyUrl()."/COCONUT/myImages/mendero.png' width='40%' height='10%'></center>";
...
echo "<table border=0>";
echo "<tr>";
echo "<td><font size=1>Patient#zzz:</font>&nbsp;</td><td>".$ro->getRegistrationDetails_patientNo()."</td>";
