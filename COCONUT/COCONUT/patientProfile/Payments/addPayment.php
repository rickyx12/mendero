...
echo "<td><input type=text name='amountPaid' value='". ($ro->hospitalBill_pf($registrationNo,"H") + $ro->getPF_notAdmitting($registrationNo) ) ."' class='shortField' autocomplete='off'></tD>";
echo "</tr>";
...
echo "<td><input type=text name='admitting' value='0' class='shortField' autocomplete='off' ></tD>";
echo "</tr>";
