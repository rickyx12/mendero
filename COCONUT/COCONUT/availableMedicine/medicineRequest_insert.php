...
$ro->requestNow($inventoryCode,$description,$quantity,$requestTo_department,$branch,$requestingDepartment,"Consolacion",$username,date("Y-m-d"),date("H:i:s"),$status,$requestNo);
