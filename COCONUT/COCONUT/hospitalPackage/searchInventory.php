...
xmlhttp.open("GET","searchInventory1.php?packageName="+document.addCharge.packageName.value+"&desc="+document.addCharge.availableCharges.value+"&packagePrice="+document.addCharge.packagePrice.value+"&phicPrice="+document.addCharge.phicPrice.value+"&searchFrom="+document.addCharge.searchFrom.value,true);
xmlhttp.send();
}
...
echo "<option value='OB PACKAGE'>OR PACKAGE</option>";
