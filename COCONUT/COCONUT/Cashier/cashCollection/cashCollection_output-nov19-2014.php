...
$hospitalCollection = ($ro->cashCollection_mmc_total() + $ro->doubleSelectNow("cashCollection","amount","date",$year."-".$month."-".$day,"type","Cash_Inpatient"));
echo "<tr>";
echo "<Td>&nbsp;<b>TOTAL CASH RECEIPTS</b></td>";
echo "<tD>&nbsp;</tD>";
echo "<tD>&nbsp;</tD>";
echo "<tD>&nbsp;<b>".number_format(( $ro->doubleSelectNow("cashCollection","amount","date",$year."-".$month."-".$day,"type","Cash_Inpatient") + $ro->cashCollection_mmc_total()),2)."</b></tD>";
echo "</tr>";
