...
echo "<form method='get' action='http://".$ro->getMyUrl()."/COCONUT/patientProfile/SOAoption/newSOA/newDetailed_opd.php'>";
}else {
...
echo "<input type=hidden name='username' value='$username'>";
echo "<input type=hidden name='show' value='try'>";
echo "<input type=submit value='S.O.A (HMO Detailed)' class='button'>";
echo "</form>";

echo "<form method='get' action='http://".$ro->getMyUrl()."/COCONUT/patientProfile/SOAoption/newSOA/newDetailed_test.php'>";
echo "<input type=hidden name='registrationNo' value='$registrationNo' >";
echo "<input type=hidden name='username' value='$username'>";
echo "<input type=hidden name='show' value='try'>";
echo "<input type=submit value='S.O.A (test)' class='button'>";
echo "</form>";
