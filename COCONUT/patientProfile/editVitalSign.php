...
echo "<center><br><div style='border:1px solid #000000; width:500px; height:250px; border-color:black black black black;'>";
echo "<br>";
...
echo "<td><input type=text name='pulse'class='txtBox' value='".$ro->getRegistrationDetails_pulse()."'></td>";
echo "</tr>";

echo "<td>Respiratory Rate&nbsp;</td>";
echo "<td><input type=text name='respiratory'class='txtBox' value='".$ro->getRegistrationDetails_respiratory()."'></td>";
echo "</tr>";
