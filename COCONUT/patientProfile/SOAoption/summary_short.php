...
echo "<tr>";
echo "<Td>&nbsp;<span class='txtSize'><b>Payment</b></span></td>";
echo "<TD></tD>";
echo "<td></td>";
echo "<td></td>";
echo "<TD><span class='txtSize'>".number_format($ro->summaryPayment($registrationNo),2)."</span></tD>";
echo "</tr>";
...
$remainBalance = ($grandTotalz - $ro->summaryPayment($registrationNo));
