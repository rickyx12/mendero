...
echo "<td>&nbsp;<font color='white'>"; echo number_format($ro->getTotal("phic","RADIOLOGY",$registrationNo),2); echo"</font>&nbsp;</td>";
...
echo "<tr>";
echo "<td>&nbsp;<b>DEPOSIT</b></td>";
echo "<td>&nbsp;<font size=3><b></b></font></tD>";
echo "<td>&nbsp;<font size=3><b></b></font></tD>";
echo "<tD>&nbsp;<font size=3><b></b></font></tD>";
//echo "<td>&nbsp;<font size=3><b>".number_format($hospitalBill_phic,2)."</b></font></tD>";
if( $ro->getInpatientPaymentSummary($registrationNo,"DEPOSIT") > 0 ) {
echo "<td>&nbsp;<font size=3><b>".number_format($ro->getInpatientPaymentSummary($registrationNo,"DEPOSIT"),2)."</b></font></tD>";
}else {
echo "<td>&nbsp;<font size=3><b></b></font></tD>";
}
echo "</tr>";
...
echo "<tr>";
echo "<td>&nbsp;<b>PARTIAL PAYMENTS</b></td>";
echo "<td>&nbsp;<font size=3><b></b></font></tD>";
echo "<td>&nbsp;<font size=3><b></b></font></tD>";
echo "<tD>&nbsp;<font size=3><b></b></font></tD>";
//echo "<td>&nbsp;<font size=3><b>".number_format($hospitalBill_phic,2)."</b></font></tD>";
if( $ro->getInpatientPaymentSummary($registrationNo,"PARTIAL PAYMENT") > 0 ) {
echo "<td>&nbsp;<font size=3><b>".number_format($ro->getInpatientPaymentSummary($registrationNo,"PARTIAL PAYMENT"),2)."</b></font></tD>";
}else {
echo "<td>&nbsp;<font size=3><b></b></font></tD>";
}
echo "</tr>";
...
echo "<tr>";
echo "<td>&nbsp;<b>PAYMENTS</b></td>";
echo "<td>&nbsp;<font size=3><b></b></font></tD>";
echo "<td>&nbsp;<font size=3><b></b></font></tD>";
echo "<tD>&nbsp;<font size=3><b></b></font></tD>";
//echo "<td>&nbsp;<font size=3><b>".number_format($hospitalBill_phic,2)."</b></font></tD>";
if( $ro->getInpatientPaymentSummary($registrationNo,"HOSPITAL BILL") > 0 ) {
echo "<td>&nbsp;<font size=3><b>".number_format($ro->getInpatientPaymentSummary($registrationNo,"HOSPITAL BILL"),2)."</b></font></tD>";
}else {
echo "<td>&nbsp;<font size=3><b></b></font></tD>";
}
echo "</tr>";
...
echo "<tD>&nbsp;<font size=3><b></b></font></tD>";
//echo "<td>&nbsp;<font size=3><b>".number_format($hospitalBill_phic,2)."</b></font></tD>";
echo "<td>&nbsp;<font size=3><b>".number_format($hospitalBill_cash - $grandTotalHB,2)."</b></font></tD>";
echo "</tr>";
...
$paymentPF = $ro->getInpatientPaymentSummary($registrationNo,"PROFESSIONAL FEE");
...
echo "<td>&nbsp;<b></b></tD>";
//echo "<td>&nbsp;<b>".$pf_phic."</b></tD>";
if( $ro->getInpatientPaymentSummary($registrationNo,"PROFESSIONAL FEE") > 0 ) {
echo "<td>&nbsp;<font size=3><b>".number_format($paymentPF,2)."</b></font></tD>";
}else {
echo "<td>&nbsp;<font size=3><b></b></font></tD>";
}
echo "<tr>";
...
echo "<td></tD>";
//echo "<td>&nbsp;<b>".$pf_phic."</b></tD>";
echo "<td>&nbsp;<b>".($pf_cash - $paymentPF)."</b></tD>";
echo "<tr>";
...
//echo "<td>&nbsp;<b>".number_format($hospitalBill_phic + $pf_phic,2)."</b>&nbsp;</tD>";
echo "<td>&nbsp;<b>".number_format( (($hospitalBill_cash + $pf_cash) - $HBandPF) ,2)."</b>&nbsp;</tD>";
echo "</tr>";
...
echo "<td>&nbsp;<b>".number_format(  (($gross - $ro->getRegistrationDetails_discount()) - $HBandPF) + $pf_cash,2)."</b>&nbsp;</tD>";
echo "</tr>";
...
if( $remainBalance > 0 ) {
echo "<td>&nbsp;<b>".number_format( ($remainBalance - $HBandPF),2)."</b>&nbsp;</tD>";
}else {
echo "<td>&nbsp;<b>".number_format( (($remainBalance + $refund) - $HBandPF) ,2)."</b>&nbsp;</tD>";
}
