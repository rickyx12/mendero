...
$packageDescription = "OB Package W/O PHIC";
$packageTotal = $splitPrePackage[1];
$packageAmount = $splitPrePackage[1];
$phicAmount = 0;
//$cashAmount = ( $packageAmount - $phicAmount );
$cashAmount = ($splitPrePackage[1]);
}else {
$packageDescription = "OB Package W/ PHIC";
$packageTotal = $splitPrePackage[2];
$packageAmount = $splitPrePackage[2];
//$phicAmount = ($splitPrePackage[1] - $splitPrePackage[2]);
$phicAmount = ( $splitPrePackage[2] - ($splitPrePackage[2] - 5000) );
//$cashAmount = ( $packageAmount - $phicAmount );
$cashAmount = ( $splitPrePackage[2] - 5000 );;
}

echo "<tr>";
echo "<td>&nbsp;<a href='http://".$ro->getMyUrl()."/COCONUT/patientProfile/SOAoption/isPackageCash.php?registrationNo=$registrationNo&username=$username' style='text-decoration:none; color:red;'>".$packageDescription."</a></tD>";
echo "<td>".number_format($packageTotal,2)."</tD>";
echo "<td>&nbsp;".number_format($phicAmount,2)."</tD>";
echo "<td>&nbsp;</tD>";
...
*/
echo "<td>&nbsp;".number_format($cashAmount,2)."</td>";
echo "<tr>";


$hospitalBill_gt1 = ( $hospitalBill_gt + $packageTotal );
$hospitalBill_phic1 = ( $hospitalBill_phic + $phicAmount );
$hospitalBill_cash1 = ( $hospitalBill_cash + $cashAmount );

echo "<tr>";
echo "<td>&nbsp;<b>Hospital Bill</b></td>";
echo "<td>&nbsp;<font size=3><b>".number_format($hospitalBill_gt1,2)."</b></font></tD>";
echo "<td>&nbsp;<font size=3><b>".number_format($hospitalBill_phic1,2)."</b></font></tD>";
...
echo "<td>&nbsp;<font size=3><b>".number_format($hospitalBill_cash1,2)."</b></font></tD>";
echo "</tr>";
...
echo "<td>&nbsp;<b>".number_format($hospitalBill_gt1 + $pf_gt,2)."</b>&nbsp;</tD>";
echo "<td>&nbsp;<b>".number_format($hospitalBill_phic1 + $pf_phic,2)."</b>&nbsp;</tD>";
