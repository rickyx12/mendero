...
echo "<td>&nbsp;<font color='black'>"; echo number_format($ro->getTotal("phic","MEDICINE",$registrationNo),2); echo"</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='black'>"; echo number_format($ro->getTotal("phic","SUPPLIES",$registrationNo),2); echo"</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='black'>"; echo number_format($ro->getTotal("phic","LABORATORY",$registrationNo),2); echo"</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='black'>"; echo number_format($ro->getTotal("phic","RADIOLOGY",$registrationNo),2); echo"</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='black'>"; echo number_format($ro->getTotal("phic","ECG",$registrationNo),2); echo"</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='black'>"; echo number_format($ro->getTotal("phic","ENDOSCOPY",$registrationNo),2); echo"</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='black'>"; echo number_format($ro->getTotal("phic","CARDIOLOGY",$registrationNo),2); echo"</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='black'>"; echo number_format($ro->getTotal("phic","MISCELLANEOUS",$registrationNo),2); echo"</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='black'>"; echo number_format($ro->getTotal("phic","OR/DR/ER FEE",$registrationNo),2); echo"</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='black'>"; echo number_format($ro->getTotal("phic","REHAB",$registrationNo),2); echo"</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='black'>"; echo number_format($ro->getTotal("phic","OXYGEN",$registrationNo),2); echo"</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='black'>"; echo number_format($ro->getTotal("phic","NITROUS",$registrationNo),2); echo"</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='black'>"; echo number_format($ro->getTotal("phic","DIALYSIS",$registrationNo),2); echo "</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='black'>"; echo number_format($ro->getTotal("phic","NBS",$registrationNo),2); echo "</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='black'>"; echo number_format($ro->getTotal("phic","CARDIAC",$registrationNo),2); echo "</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='black'>"; echo number_format($ro->getTotal("phic","BLOODBANK",$registrationNo),2); echo "</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='black'>"; echo number_format($ro->getTotal("phic","VENTILATOR",$registrationNo),2); echo "</font>&nbsp;</td>";
...
echo "<td>&nbsp;<font color='black'>"; echo number_format($ro->getTotal("phic","PULSE_OXIMETER",$registrationNo),2); echo "</font>&nbsp;</td>";
...
<Table width='100%'>
<tD>
<font size=2><u>".strtoupper($logusername)."&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</u><Br><b>Billing Section</b></font>
</tD>
