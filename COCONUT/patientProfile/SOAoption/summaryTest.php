...
echo "<tr>";
echo "<td>&nbsp;<span class='txtSize'><b>DEPOSIT</b></span></td>";
echo "<td>&nbsp;<font size=3><b></b></font></tD>";
echo "<td>&nbsp;<font size=3><b></b></font></tD>";
echo "<tD>&nbsp;<font size=3><b></b></font></tD>";
//echo "<td>&nbsp;<font size=3><b>".number_format($hospitalBill_phic,2)."</b></font></tD>";
if( $ro->getInpatientPaymentSummary($registrationNo,"DEPOSIT") > 0 ) {
echo "<td>&nbsp;<span class='txtSize'><b>".number_format($ro->getInpatientPaymentSummary($registrationNo,"DEPOSIT"),2)."</b></span></tD>";
}else {
echo "<td>&nbsp;<font size=3><b></b></font></tD>";
}
echo "</tr>";
...
echo "<tr>";
echo "<td>&nbsp;<span class='txtSize'><b>PARTIAL PAYMENTS</b></span></td>";
echo "<td>&nbsp;<font size=3><b></b></font></tD>";
echo "<td>&nbsp;<font size=3><b></b></font></tD>";
echo "<tD>&nbsp;<font size=3><b></b></font></tD>";
//echo "<td>&nbsp;<font size=3><b>".number_format($hospitalBill_phic,2)."</b></font></tD>";
if( $ro->getInpatientPaymentSummary($registrationNo,"PARTIAL PAYMENT") > 0 ) {
echo "<td>&nbsp;<span class='txtSize'><b>".number_format($ro->getInpatientPaymentSummary($registrationNo,"PARTIAL PAYMENT"),2)."</b></span></tD>";
}else {
echo "<td>&nbsp;<font size=3><b></b></font></tD>";
}
echo "</tr>";
...
echo "<tr>";
echo "<td>&nbsp;<span class='txtSize'><b>PAYMENTS</b></span></td>";
echo "<td>&nbsp;<font size=3><b></b></font></tD>";
echo "<td>&nbsp;<font size=3><b></b></font></tD>";
echo "<tD>&nbsp;<font size=3><b></b></font></tD>";
//echo "<td>&nbsp;<font size=3><b>".number_format($hospitalBill_phic,2)."</b></font></tD>";
if( $ro->getInpatientPaymentSummary($registrationNo,"HOSPITAL BILL") > 0 ) {
echo "<td>&nbsp;<span class='txtSize'><b>".number_format($ro->getInpatientPaymentSummary($registrationNo,"HOSPITAL BILL"),2)."</b></span></tD>";
}else {
echo "<td>&nbsp;<font size=3><b></b></font></tD>";
}
echo "</tr>";

$grandTotalHB = ( $ro->getInpatientPaymentSummary($registrationNo,"DEPOSIT") + $ro->getInpatientPaymentSummary($registrationNo,"PARTIAL PAYMENT") + $ro->getInpatientPaymentSummary($registrationNo,"HOSPITAL BILL") );
...
echo "<tD>&nbsp;<font size=3><b></b></font></tD>";
//echo "<td>&nbsp;<font size=3><b>".number_format($hospitalBill_phic,2)."</b></font></tD>";
echo "<td>&nbsp;<span class='txtSize'><b>".number_format(($hospitalBill_cash - $grandTotalHB) + $refund,2)."</b></span></tD>";
echo "</tr>";
...
$paymentPF = $ro->getInpatientPaymentSummary_pf($registrationNo);

echo "<tr>";
echo "<td><b></b></tD>";
echo "<td><span class='txtSize'>&nbsp;<b>".$pf_gt."</b></tD>";
echo "<td><span class='txtSize'>&nbsp;<b>".$pf_phic."</b></span></tD>";
echo "<td><span class='txtSize'>&nbsp;<b>".$pf_company."</b></span></tD>";
//echo "<td>&nbsp;<b>".$pf_phic."</b></tD>";
echo "<td><span class='txtSize'>&nbsp;<b>".$pf_cash."</b></span></tD>";
echo "<tr>";
...
echo "<td>&nbsp;<b></b></tD>";
//echo "<td>&nbsp;<b>".$pf_phic."</b></tD>";
if( $ro->getInpatientPaymentSummary_pf($registrationNo,"PROFESSIONAL FEE") > 0 ) {
echo "<td>&nbsp;<span class='txtSize'><b>".number_format($paymentPF,2)."</b></span></tD>";
}else {
echo "<td>&nbsp;<font size=3><b></b></font></tD>";
}
echo "<tr>";
...
$HBandPF = ( $grandTotalHB + $paymentPF );
...
echo "<td>&nbsp;<span class='txtSize'><b>".number_format( (((($gross - $ro->getRegistrationDetails_discount()  ) + $pf_cash) - $HBandPF) + $refund),2)."</b></span>&nbsp;</tD>";
echo "</tr>";
...
if( $remainBalance > 0 ) {
echo "<td>&nbsp;<span class='txtSize'><b>".number_format( ($remainBalance - $HBandPF) + $refund,2)."</b></span>&nbsp;</tD>";
}else {
echo "<td>&nbsp;<span class='txtSize'><b>".number_format( ((($remainBalance + $refund) - $HBandPF) + $refund) ,2)."</b></span>&nbsp;</tD>";
}
