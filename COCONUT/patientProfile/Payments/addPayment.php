...
echo "<br><br><br><center><div style='border:1px solid #000000; width:600px; height:355px; border-color:black black black black;'>";
echo "<Br>";
echo "<Table border=0>";
echo "<tr>";
...
echo "<option value='PCSO W/ L.O.A'>PCSO W/ L.O.A</option>";
echo "<option value='INSULAR LIFE W/ L.O.A'>INSULAR LIFE W/ L.O.A</option>";
echo "<option value='PARTIAL PAYMENT'>PARTIAL PAYMENT</option>";
echo "<option value='DEPOSIT'>DEPOSIT</option>";
echo "<option value='MMC'>MMC</option>";
...
//echo "<td><input type=text name='amountPaid' value='".($ro->hospitalBill_pf($registrationNo,"H") + $ro->hospitalBill_pf($registrationNo,"MEDICINE") + $ro->hospitalBill_pf($registrationNo,"SUPPLIES")) ."' class='shortField' autocomplete='off'></tD>";
echo "<td><input type=text name='amountPaid' value='' class='shortField' autocomplete='off'></tD>";
echo "</tr>";

echo "<tr>";
echo "<td><font class='labelz'>PF</font></tD>";
//echo "<td><input type=text name='pf' value='".$ro->hospitalBill_pf($registrationNo,"PROFESSIONAL FEE")."' class='shortField' autocomplete='off' ></tD>";
echo "<td><input type=text name='pf' value='' class='shortField' autocomplete='off' ></tD>";
echo "</tr>";
...
echo "<td>Receipt</td>";
echo "<Td>";
$ro->coconutComboBoxStart_long("receiptType");
