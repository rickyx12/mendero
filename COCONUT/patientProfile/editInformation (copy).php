...
echo "<option value='".$ro->selectNow("registrationDetails","dischargeCondition","registrationNo",$registrationNo)."'>".$ro->selectNow("registrationDetails","dischargeCondition","registrationNo",$registrationNo)."</option>";
...
echo "<tr>"; echo "<td><font class='labelz'>Discount (Cash)</font></td>"; echo "<td><input type=text maxlength=10 name='discount' autocomplete='off' value='".$ro->getRegistrationDetails_discount()."' class='shortField'></td>"; echo "</tr>";  echo "<tr>"; echo "<td><font class='labelz'>Discount(Company)</font></td>"; echo "<td><input type=text maxlength=10 name='companyDiscount' autocomplete=off value='".$ro->selectNow("registrationDetails","companyDiscount","registrationNo",$registrationNo)."' class='shortField'></td>"; echo "</tr>";
}else {
