...
echo "<form method='get' action='toDischarge1.php'>";
$ro->coconutHidden("username",$username);
echo "<center><br><br><Br><font size=3 color=red></font><br><div style='border:1px solid #000000; width:500px; height:150px; border-color:black black black black;'>";
