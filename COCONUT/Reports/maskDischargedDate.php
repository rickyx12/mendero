...
echo "<form method='get' action='maskDischargedDate1.php'>";
echo "<center><br><br><Br><font size=3 color=red></font><br><div style='border:1px solid #000000; width:500px; height:100px; border-color:black black black black;'>";
