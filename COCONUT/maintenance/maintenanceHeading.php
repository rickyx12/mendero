...
<li><a href="http://<?php echo $ro->getMyUrl(); ?>/Maintenance/addCharges.php?module=ENDOSCOPY&username=<?php echo $username; ?>" target="departmentX">ENDOSCOPY Charges</a></li>
...
<li><a href="http://<?php echo $ro->getMyUrl(); ?>/Maintenance/addCharges.php?module=CARDIOLOGY&username=<?php echo $username; ?>" target="departmentX">Cardiology Charges</a></li>
...
<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/charges.php?username=<?php echo $username; ?>&title=OXYGEN&show=All" target="departmentX">OXYGEN Charges</a></li>
...
<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/charges.php?username=<?php echo $username; ?>&title=ENDOSCOPY&show=All" target="departmentX">ENDOSCOPY Charges</a></li>
...
<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/charges.php?username=<?php echo $username; ?>&title=CARDIOLOGY&show=All" target="departmentX">Cardiology Charges</a></li>
...
<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/package.php?username=<?php echo $username; ?>" target="departmentX">Package</a></li>
                    ...
                    <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=medicine&branch=All&show=All&inventoryLocation=" target='departmentX'>Medicine</a></li>

<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=supplies&branch=All&show=All&inventoryLocation=" target='departmentX'>Supplies</a></li>

                    <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=All&inventoryLocation=PHARMACY" target='departmentX'>Pharmacy</a></li>

                    <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=All&inventoryLocation=ER E Cart" target='departmentX'>ER E Cart</a></li>

                    <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=All&inventoryLocation=OR E Cart" target='departmentX'>OR E Cart</a></li>


                    <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=All&inventoryLocation=DR E Cart" target='departmentX'>DR E Cart</a></li>

<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=All&inventoryLocation=3A E Cart" target='departmentX'>3A E CART</a></li>

                    <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=All&inventoryLocation=3B E Cart" target='departmentX'>3B E CART</a></li>

<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=All&inventoryLocation=4A E Cart" target='departmentX'>4A E CART</a></li>

                    <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=All&inventoryLocation=4B E Cart" target='departmentX'>4B E CART</a></li>


                   <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=All&inventoryLocation=ICU E Cart" target='departmentX'>ICU E CART</a></li>

                   <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=All&inventoryLocation=ENDOSCOPY E Cart" target='departmentX'>ENDOSCOPY E CART</a></li>

                   <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=All&inventoryLocation=HEMODIALYSIS E Cart" target='departmentX'>HEMODIALYSIS E CART</a></li>


                   <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=All&inventoryLocation=CARDIOLOGY E Cart" target='departmentX'>CARDIOLOGY E CART</a></li>


                   <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=All&inventoryLocation=RADIOLOGY E CART" target='departmentX'>RADIOLOGY E CART</a></li>


 <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=All&inventoryLocation=RADIOLOGY E CART" target='departmentX'>CSR</a></li>


<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=All&inventoryLocation=PICU" target='departmentX'>PICU</a></li>


<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=All&inventoryLocation=OB PACKAGE" target='departmentX'>OB PACKAGE</a></li>


<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=All&inventoryLocation=OR PACKAGE" target='departmentX'>OR PACKAGE</a></li>


<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/masterfile/inventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=All&inventoryLocation=(MINOR OR) ER PACKAGE" target='departmentX'>(MINOR OR) ER PACKAGE</a></li>
...
<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/maintenance/searchCharges.php?username=<?php echo $username; ?>&title=ENDOSCOPY&show=search" target="departmentX">ENDOSCOPY Charges</a></li>
...
<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/maintenance/searchCharges.php?username=<?php echo $username; ?>&title=OTHERS&show=search" target="departmentX">Other's</a></li>
                    ...
                    <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/maintenance/searchInventory.php?username=<?php echo $username; ?>&inventoryType=medicine&branch=All&show=search&inventoryLocation=" target='departmentX'>Medicine</a></li>

<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/maintenance/searchInventory.php?username=<?php echo $username; ?>&inventoryType=supplies&branch=All&show=search&inventoryLocation=" target='departmentX'>Supplies</a></li>

                    <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/maintenance/searchInventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=search&inventoryLocation=PHARMACY" target='departmentX'>Pharmacy</a></li>

                    <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/maintenance/searchInventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=search&inventoryLocation=OR E Cart" target='departmentX'>OR E Cart</a></li>

                    <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/maintenance/searchInventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=search&inventoryLocation=ER E Cart" target='departmentX'>ER E Cart</a></li>

                    <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/maintenance/searchInventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=search&inventoryLocation=3A E CART" target='departmentX'>3A E CART</a></li>

                    <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/maintenance/searchInventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=search&inventoryLocation=4A E CART" target='departmentX'>4A E CART</a></li>

 <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/maintenance/searchInventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=search&inventoryLocation=DR E CART" target='departmentX'>DR E CART</a></li>


                   <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/maintenance/searchInventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=search&inventoryLocation=3B E CART" target='departmentX'>3B E CART</a></li>

                   <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/maintenance/searchInventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=search&inventoryLocation=4B E CART" target='departmentX'>4B E CART</a></li>

                     <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/maintenance/searchInventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=search&inventoryLocation=ICU E CART" target='departmentX'>ICU E CART</a></li>

                     <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/maintenance/searchInventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=search&inventoryLocation=ENDOSCOPY E Cart" target='departmentX'>ENDOSCOPY E CART</a></li>

                     <li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/maintenance/searchInventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=search&inventoryLocation=CARDIOLOGY E Cart" target='departmentX'>CARDIOLOGY E CART</a></li>

<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/maintenance/searchInventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=search&inventoryLocation=CSR" target='departmentX'>CSR</a></li>


<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/maintenance/searchInventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=search&inventoryLocation=PICU" target='departmentX'>PICU</a></li>


<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/maintenance/searchInventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=search&inventoryLocation=OB PACKAGE" target='departmentX'>OB PACKAGE</a></li>


<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/maintenance/searchInventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=search&inventoryLocation=OR PACKAGE" target='departmentX'>OR PACKAGE</a></li>

<li><a href="http://<?php echo $ro->getMyUrl(); ?>/COCONUT/maintenance/searchInventory.php?username=<?php echo $username; ?>&inventoryType=&branch=All&show=search&inventoryLocation=(MINOR OR) ER PACKAGE" target='departmentX'>(MINOR OR) ER PACKAGE</a></li>                    
