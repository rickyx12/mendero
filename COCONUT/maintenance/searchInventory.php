...
xmlhttp.open("GET","searchAvailableInventoryNow.php?inventoryType="+document.addCharge.inventoryType.value+"&username="+document.addCharge.username.value+"&show="+document.addCharge.show.value+"&branch="+document.addCharge.branch.value+"&description="+document.addCharge.description.value+"&inventoryLocation="+document.addCharge.inventoryLocation.value,true);
xmlhttp.send();
}
...
echo "<input type=hidden name='inventoryLocation' value='$inventoryLocation'>";
echo "</form>";
