...
echo "<td><input type=text class='txtBox' name='description' autocomplete='off' value='$description'></td>";
echo "</tr>";
echo "<tr>";
echo "<td><font class='labelz'>Generic&nbsp;</font></td>";
echo "<td><input type=text class='txtBox' name='generic' autocomplete='off' value='$genericName'></td>";
echo "</tr>";
echo "<tr>";
echo "<tr>";
