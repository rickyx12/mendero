...
xmlhttp.open("GET","search.php?description="+document.addCharge.description.value+"&username="+document.addCharge.username.value+"&department="+document.addCharge.department.value,true);
xmlhttp.send();
}
